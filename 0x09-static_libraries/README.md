Name: Super Sexy girl
Cohort 13

0X09.C STATIC LIBRARIES A library is not a luxury but one of the necessities of life. 
Create the static library libmy.a containing all the functions listed below: _putchar: 
Writes a single character to standard output. _islower: Checks if a character is a lowercase letter. 
